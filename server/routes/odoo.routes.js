...
// liquid: team_name LIQ% or G1/G2/…, or note TEAM/TIM LIQUID SHIFT, or empty-note SKU fallback
// device: DEV% or device notes, or empty-note SKU with POD only
// cartridge: TEAM/TIM cartridge + CT, or empty-note SKU with CARTRIDGE/CT
